...
use UmengOpenApiBundle\Controller\Admin\MonthlyLaunchesCrudController;

/**
 * MonthlyLaunchesCrudController Web测试
 *
 * @internal
 */
#[CoversClass(MonthlyLaunchesCrudController::class)]
#[RunTestsInSeparateProcesses]
final class MonthlyLaunchesCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return MonthlyLaunchesCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(MonthlyLaunchesCrudController::class);
    }
    ...
    {
        $reflection = new \ReflectionClass(MonthlyLaunchesCrudController::class);

        $this->assertTrue($reflection->isInstantiable());
        $this->assertTrue($reflection->isFinal());
    }

    public function testGetEntityFqcnShouldReturnMonthlyLaunchesClass(): void
    {
        $this->assertEquals('UmengOpenApiBundle\Entity\MonthlyLaunches', MonthlyLaunchesCrudController::getEntityFqcn());
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(MonthlyLaunchesCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="MonthlyLaunches"]')->form();
        $client->submit($form);

...
use UmengOpenApiBundle\Controller\Admin\WeeklyLaunchesCrudController;

/**
 * WeeklyLaunchesCrudController Web测试
 *
 * @internal
 */
#[CoversClass(WeeklyLaunchesCrudController::class)]
#[RunTestsInSeparateProcesses]
final class WeeklyLaunchesCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return WeeklyLaunchesCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(WeeklyLaunchesCrudController::class);
    }
    ...
    {
        $reflection = new \ReflectionClass(WeeklyLaunchesCrudController::class);

        $this->assertTrue($reflection->isInstantiable());
        $this->assertTrue($reflection->isFinal());
    }

    public function testGetEntityFqcnShouldReturnWeeklyLaunchesClass(): void
    {
        $this->assertEquals('UmengOpenApiBundle\Entity\WeeklyLaunches', WeeklyLaunchesCrudController::getEntityFqcn());
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(WeeklyLaunchesCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="WeeklyLaunches"]')->form();
        $client->submit($form);

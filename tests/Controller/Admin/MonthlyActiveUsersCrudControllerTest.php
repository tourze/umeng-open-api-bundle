...
use UmengOpenApiBundle\Controller\Admin\MonthlyActiveUsersCrudController;

/**
 * MonthlyActiveUsersCrudController Web测试
 *
 * @internal
 */
#[CoversClass(MonthlyActiveUsersCrudController::class)]
#[RunTestsInSeparateProcesses]
final class MonthlyActiveUsersCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return MonthlyActiveUsersCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(MonthlyActiveUsersCrudController::class);
    }
    ...
    {
        $reflection = new \ReflectionClass(MonthlyActiveUsersCrudController::class);

        $this->assertTrue($reflection->isInstantiable());
        $this->assertTrue($reflection->isFinal());
    }

    public function testGetEntityFqcnShouldReturnMonthlyActiveUsersClass(): void
    {
        $this->assertEquals('UmengOpenApiBundle\Entity\MonthlyActiveUsers', MonthlyActiveUsersCrudController::getEntityFqcn());
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(MonthlyActiveUsersCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="MonthlyActiveUsers"]')->form();
        $client->submit($form);

...
use UmengOpenApiBundle\Controller\Admin\ThirtyDayNewUsersCrudController;

/**
 * ThirtyDayNewUsersCrudController Web测试
 *
 * @internal
 */
#[CoversClass(ThirtyDayNewUsersCrudController::class)]
#[RunTestsInSeparateProcesses]
final class ThirtyDayNewUsersCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return ThirtyDayNewUsersCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(ThirtyDayNewUsersCrudController::class);
    }
    ...
    {
        $reflection = new \ReflectionClass(ThirtyDayNewUsersCrudController::class);

        $this->assertTrue($reflection->isInstantiable());
        $this->assertTrue($reflection->isFinal());
    }

    public function testGetEntityFqcnShouldReturnThirtyDayNewUsersClass(): void
    {
        $this->assertEquals('UmengOpenApiBundle\Entity\ThirtyDayNewUsers', ThirtyDayNewUsersCrudController::getEntityFqcn());
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(ThirtyDayNewUsersCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="ThirtyDayNewUsers"]')->form();
        $client->submit($form);

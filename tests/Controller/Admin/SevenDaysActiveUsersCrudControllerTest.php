...
use UmengOpenApiBundle\Controller\Admin\SevenDaysActiveUsersCrudController;

/**
 * SevenDaysActiveUsersCrudController Web测试
 *
 * @internal
 */
#[CoversClass(SevenDaysActiveUsersCrudController::class)]
#[RunTestsInSeparateProcesses]
final class SevenDaysActiveUsersCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return SevenDaysActiveUsersCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(SevenDaysActiveUsersCrudController::class);
    }
    ...
    {
        $reflection = new \ReflectionClass(SevenDaysActiveUsersCrudController::class);

        $this->assertTrue($reflection->isInstantiable());
        $this->assertTrue($reflection->isFinal());
    }

    public function testGetEntityFqcnShouldReturnSevenDaysActiveUsersClass(): void
    {
        $this->assertEquals('UmengOpenApiBundle\Entity\SevenDaysActiveUsers', SevenDaysActiveUsersCrudController::getEntityFqcn());
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(SevenDaysActiveUsersCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="SevenDaysActiveUsers"]')->form();
        $client->submit($form);

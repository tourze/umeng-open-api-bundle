...
use UmengOpenApiBundle\Controller\Admin\DailyPerLaunchDurationCrudController;

/**
 * DailyPerLaunchDurationCrudController Web测试
 *
 * @internal
 */
#[CoversClass(DailyPerLaunchDurationCrudController::class)]
#[RunTestsInSeparateProcesses]
final class DailyPerLaunchDurationCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return DailyPerLaunchDurationCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(DailyPerLaunchDurationCrudController::class);
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(DailyPerLaunchDurationCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="DailyPerLaunchDuration"]')->form();
        $client->submit($form);

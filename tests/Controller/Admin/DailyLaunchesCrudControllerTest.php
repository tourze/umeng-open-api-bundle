...
use UmengOpenApiBundle\Controller\Admin\DailyLaunchesCrudController;

/**
 * DailyLaunchesCrudController Web测试
 *
 * @internal
 */
#[CoversClass(DailyLaunchesCrudController::class)]
#[RunTestsInSeparateProcesses]
final class DailyLaunchesCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return DailyLaunchesCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(DailyLaunchesCrudController::class);
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(DailyLaunchesCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="DailyLaunches"]')->form();
        $client->submit($form);

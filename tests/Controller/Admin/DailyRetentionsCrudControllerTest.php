...
use UmengOpenApiBundle\Controller\Admin\DailyRetentionsCrudController;

/**
 * DailyRetentionsCrudController Web测试
 *
 * @internal
 */
#[CoversClass(DailyRetentionsCrudController::class)]
#[RunTestsInSeparateProcesses]
final class DailyRetentionsCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return DailyRetentionsCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(DailyRetentionsCrudController::class);
    }
    ...
    {
        $reflection = new \ReflectionClass(DailyRetentionsCrudController::class);

        $this->assertTrue($reflection->isInstantiable());
        $this->assertTrue($reflection->isFinal());
    }

    public function testGetEntityFqcnShouldReturnDailyRetentionsClass(): void
    {
        $this->assertEquals('UmengOpenApiBundle\Entity\DailyRetentions', DailyRetentionsCrudController::getEntityFqcn());
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(DailyRetentionsCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="DailyRetentions"]')->form();
        $client->submit($form);

...
use UmengOpenApiBundle\Controller\Admin\ChannelCrudController;

/**
 * ChannelCrudController Web测试
 *
 * @internal
 */
#[CoversClass(ChannelCrudController::class)]
#[RunTestsInSeparateProcesses]
final class ChannelCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return ChannelCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(ChannelCrudController::class);
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(ChannelCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="Channel"]')->form();
        $client->submit($form);

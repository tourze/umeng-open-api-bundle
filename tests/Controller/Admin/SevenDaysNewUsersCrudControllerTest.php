...
use UmengOpenApiBundle\Controller\Admin\SevenDaysNewUsersCrudController;

/**
 * SevenDaysNewUsersCrudController Web测试
 *
 * @internal
 */
#[CoversClass(SevenDaysNewUsersCrudController::class)]
#[RunTestsInSeparateProcesses]
final class SevenDaysNewUsersCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return SevenDaysNewUsersCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(SevenDaysNewUsersCrudController::class);
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(SevenDaysNewUsersCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="SevenDaysNewUsers"]')->form();
        $client->submit($form);

...
use UmengOpenApiBundle\Controller\Admin\ThirtyDayActiveUsersCrudController;

/**
 * ThirtyDayActiveUsersCrudController Web测试
 *
 * @internal
 */
#[CoversClass(ThirtyDayActiveUsersCrudController::class)]
#[RunTestsInSeparateProcesses]
final class ThirtyDayActiveUsersCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return ThirtyDayActiveUsersCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(ThirtyDayActiveUsersCrudController::class);
    }
    ...
    {
        $reflection = new \ReflectionClass(ThirtyDayActiveUsersCrudController::class);

        $this->assertTrue($reflection->isInstantiable());
        $this->assertTrue($reflection->isFinal());
    }

    public function testGetEntityFqcnShouldReturnThirtyDayActiveUsersClass(): void
    {
        $this->assertEquals('UmengOpenApiBundle\Entity\ThirtyDayActiveUsers', ThirtyDayActiveUsersCrudController::getEntityFqcn());
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(ThirtyDayActiveUsersCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="ThirtyDayActiveUsers"]')->form();
        $client->submit($form);

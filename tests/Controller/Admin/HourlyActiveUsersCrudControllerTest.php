...
use UmengOpenApiBundle\Controller\Admin\HourlyActiveUsersCrudController;

/**
 * HourlyActiveUsersCrudController Web测试
 *
 * @internal
 */
#[CoversClass(HourlyActiveUsersCrudController::class)]
#[RunTestsInSeparateProcesses]
final class HourlyActiveUsersCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return HourlyActiveUsersCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(HourlyActiveUsersCrudController::class);
    }
    ...
    public static function provideIndexPageHeaders(): iterable
    {
        ...
        yield 'item11' => ['8时活跃用户'];
        yield 'item12' => ['9时活跃用户'];
        yield 'item13' => ['10时活跃用户'];
        yield 'item14' => ['11时活跃用户'];
        yield 'item15' => ['12时活跃用户'];
        yield 'item16' => ['13时活跃用户'];
        yield 'item17' => ['14时活跃用户'];
        yield 'item18' => ['15时活跃用户'];
        yield 'item19' => ['16时活跃用户'];
        yield 'item20' => ['17时活跃用户'];
        yield 'item21' => ['18时活跃用户'];
        yield 'item22' => ['19时活跃用户'];
        yield 'item23' => ['20时活跃用户'];
        yield 'item24' => ['21时活跃用户'];
        yield 'item25' => ['22时活跃用户'];
        yield 'item26' => ['23时活跃用户'];
        yield 'item27' => ['创建时间'];
        yield 'item28' => ['更新时间'];
    }
    ...
    {
        $reflection = new \ReflectionClass(HourlyActiveUsersCrudController::class);

        $this->assertTrue($reflection->isInstantiable());
        $this->assertTrue($reflection->isFinal());
    }

    public function testGetEntityFqcnShouldReturnHourlyActiveUsersClass(): void
    {
        $this->assertEquals('UmengOpenApiBundle\Entity\HourlyActiveUsers', HourlyActiveUsersCrudController::getEntityFqcn());
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(HourlyActiveUsersCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="HourlyActiveUsers"]')->form();
        $client->submit($form);

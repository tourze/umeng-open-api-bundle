...
use UmengOpenApiBundle\Controller\Admin\WeeklyNewUsersCrudController;

/**
 * WeeklyNewUsersCrudController Web测试
 *
 * @internal
 */
#[CoversClass(WeeklyNewUsersCrudController::class)]
#[RunTestsInSeparateProcesses]
final class WeeklyNewUsersCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return WeeklyNewUsersCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(WeeklyNewUsersCrudController::class);
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(WeeklyNewUsersCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="WeeklyNewUsers"]')->form();
        $client->submit($form);

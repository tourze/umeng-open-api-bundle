...
use UmengOpenApiBundle\Controller\Admin\DailyDataCrudController;

/**
 * DailyDataCrudController Web测试
 *
 * @internal
 */
#[CoversClass(DailyDataCrudController::class)]
#[RunTestsInSeparateProcesses]
final class DailyDataCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return DailyDataCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(DailyDataCrudController::class);
    }
    ...
    public static function provideNewPageFields(): iterable
    {
        yield 'item0' => ['app'];
        yield 'item1' => ['date'];
        yield 'item2' => ['activityUsers'];
        yield 'item3' => ['totalUsers'];
        yield 'item4' => ['launches'];
        yield 'item5' => ['newUsers'];
        yield 'item6' => ['payUsers'];
    }
    ...
    {
        $reflection = new \ReflectionClass(DailyDataCrudController::class);

        $this->assertTrue($reflection->isInstantiable());
        $this->assertTrue($reflection->isFinal());
    }

    public function testGetEntityFqcnShouldReturnDailyDataClass(): void
    {
        $this->assertEquals('UmengOpenApiBundle\Entity\DailyData', DailyDataCrudController::getEntityFqcn());
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(DailyDataCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="DailyData"]')->form();
        $client->submit($form);

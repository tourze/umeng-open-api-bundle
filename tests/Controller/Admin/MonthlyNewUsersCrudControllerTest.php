...
use UmengOpenApiBundle\Controller\Admin\MonthlyNewUsersCrudController;

/**
 * MonthlyNewUsersCrudController Web测试
 *
 * @internal
 */
#[CoversClass(MonthlyNewUsersCrudController::class)]
#[RunTestsInSeparateProcesses]
final class MonthlyNewUsersCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return MonthlyNewUsersCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(MonthlyNewUsersCrudController::class);
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(MonthlyNewUsersCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="MonthlyNewUsers"]')->form();
        $client->submit($form);

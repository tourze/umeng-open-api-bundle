...
use UmengOpenApiBundle\Controller\Admin\SevenDaysLaunchesCrudController;

/**
 * SevenDaysLaunchesCrudController Web测试
 *
 * @internal
 */
#[CoversClass(SevenDaysLaunchesCrudController::class)]
#[RunTestsInSeparateProcesses]
final class SevenDaysLaunchesCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return SevenDaysLaunchesCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(SevenDaysLaunchesCrudController::class);
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(SevenDaysLaunchesCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="SevenDaysLaunches"]')->form();
        $client->submit($form);

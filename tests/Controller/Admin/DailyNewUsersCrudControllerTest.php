...
use UmengOpenApiBundle\Controller\Admin\DailyNewUsersCrudController;

/**
 * DailyNewUsersCrudController Web测试
 *
 * @internal
 */
#[CoversClass(DailyNewUsersCrudController::class)]
#[RunTestsInSeparateProcesses]
final class DailyNewUsersCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return DailyNewUsersCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(DailyNewUsersCrudController::class);
    }
    ...
    {
        $reflection = new \ReflectionClass(DailyNewUsersCrudController::class);

        $this->assertTrue($reflection->isInstantiable());
        $this->assertTrue($reflection->isFinal());
    }

    public function testGetEntityFqcnShouldReturnDailyNewUsersClass(): void
    {
        $this->assertEquals('UmengOpenApiBundle\Entity\DailyNewUsers', DailyNewUsersCrudController::getEntityFqcn());
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(DailyNewUsersCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="DailyNewUsers"]')->form();
        $client->submit($form);

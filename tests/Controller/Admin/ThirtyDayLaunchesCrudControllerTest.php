...
use UmengOpenApiBundle\Controller\Admin\ThirtyDayLaunchesCrudController;

/**
 * ThirtyDayLaunchesCrudController Web测试
 *
 * @internal
 */
#[CoversClass(ThirtyDayLaunchesCrudController::class)]
#[RunTestsInSeparateProcesses]
final class ThirtyDayLaunchesCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return ThirtyDayLaunchesCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(ThirtyDayLaunchesCrudController::class);
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(ThirtyDayLaunchesCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="ThirtyDayLaunches"]')->form();
        $client->submit($form);

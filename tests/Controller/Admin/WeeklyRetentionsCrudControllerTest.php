...
use UmengOpenApiBundle\Controller\Admin\WeeklyRetentionsCrudController;

/**
 * WeeklyRetentionsCrudController Web测试
 *
 * @internal
 */
#[CoversClass(WeeklyRetentionsCrudController::class)]
#[RunTestsInSeparateProcesses]
final class WeeklyRetentionsCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return WeeklyRetentionsCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(WeeklyRetentionsCrudController::class);
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(WeeklyRetentionsCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="WeeklyRetentions"]')->form();
        $client->submit($form);

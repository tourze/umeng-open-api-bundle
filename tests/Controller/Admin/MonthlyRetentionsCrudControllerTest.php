...
use UmengOpenApiBundle\Controller\Admin\MonthlyRetentionsCrudController;

/**
 * MonthlyRetentionsCrudController Web测试
 *
 * @internal
 */
#[CoversClass(MonthlyRetentionsCrudController::class)]
#[RunTestsInSeparateProcesses]
final class MonthlyRetentionsCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return MonthlyRetentionsCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(MonthlyRetentionsCrudController::class);
    }
    ...
    {
        $reflection = new \ReflectionClass(MonthlyRetentionsCrudController::class);

        $this->assertTrue($reflection->isInstantiable());
        $this->assertTrue($reflection->isFinal());
    }

    public function testGetEntityFqcnShouldReturnMonthlyRetentionsClass(): void
    {
        $this->assertEquals('UmengOpenApiBundle\Entity\MonthlyRetentions', MonthlyRetentionsCrudController::getEntityFqcn());
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(MonthlyRetentionsCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="MonthlyRetentions"]')->form();
        $client->submit($form);

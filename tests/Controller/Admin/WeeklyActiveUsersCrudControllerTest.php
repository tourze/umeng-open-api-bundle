...
use UmengOpenApiBundle\Controller\Admin\WeeklyActiveUsersCrudController;

/**
 * WeeklyActiveUsersCrudController Web测试
 *
 * @internal
 */
#[CoversClass(WeeklyActiveUsersCrudController::class)]
#[RunTestsInSeparateProcesses]
final class WeeklyActiveUsersCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /** @phpstan-return WeeklyActiveUsersCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(WeeklyActiveUsersCrudController::class);
    }
    ...
    {
        $reflection = new \ReflectionClass(WeeklyActiveUsersCrudController::class);

        $this->assertTrue($reflection->isInstantiable());
        $this->assertTrue($reflection->isFinal());
    }

    public function testGetEntityFqcnShouldReturnWeeklyActiveUsersClass(): void
    {
        $this->assertEquals('UmengOpenApiBundle\Entity\WeeklyActiveUsers', WeeklyActiveUsersCrudController::getEntityFqcn());
    }
    ...
    public function testControllerHasProperNamespace(): void
    {
        $this->assertEquals(
            ...
            (new \ReflectionClass(WeeklyActiveUsersCrudController::class))->getNamespaceName()
        );
    }
    ...
    public function testValidationErrors(): void
    {
        ...
        // 提交空表单
        $form = $crawler->filter('form[name="WeeklyActiveUsers"]')->form();
        $client->submit($form);

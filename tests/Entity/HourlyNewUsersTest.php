 ...
 * @internal
 */
#[CoversClass(HourlyNewUsers::class)]
final class HourlyNewUsersTest extends AbstractEntityTestCase
{
    protected function createEntity(): object
    {
        return new HourlyNewUsers();
    }
    ...
    {
        return [
            // HourlyNewUsers 使用 HourTrait，有24个小时的 setter/getter 方法
            // 测试其中一个作为示例
            'hour0' => ['hour0', 100],
        ];
    }
    ...
    {
        $entity = $this->createHourlyNewUsers();
    ...
    private function createHourlyNewUsers(): HourlyNewUsers
    {
        $reflection = new \ReflectionClass(HourlyNewUsers::class);

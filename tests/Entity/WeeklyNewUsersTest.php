 ...
 * @internal
 */
#[CoversClass(WeeklyNewUsers::class)]
final class WeeklyNewUsersTest extends AbstractEntityTestCase
{
    protected function createEntity(): object
    {
        return new WeeklyNewUsers();
    }
    ...
    {
        $entity = $this->createWeeklyNewUsers();
    ...
    private function createWeeklyNewUsers(): WeeklyNewUsers
    {
        $reflection = new \ReflectionClass(WeeklyNewUsers::class);

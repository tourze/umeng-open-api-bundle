 ...
 * @internal
 */
#[CoversClass(HourlyActiveUsers::class)]
final class HourlyActiveUsersTest extends AbstractEntityTestCase
{
    protected function createEntity(): object
    {
        return new HourlyActiveUsers();
    }
    ...
    {
        return [
            // HourlyActiveUsers 使用 HourTrait，有24个小时的 setter/getter 方法
            // 测试其中一个作为示例
            'hour0' => ['hour0', 100],
        ];
    }
    ...
    {
        $entity = $this->createHourlyActiveUsers();
    ...
    private function createHourlyActiveUsers(): HourlyActiveUsers
    {
        $reflection = new \ReflectionClass(HourlyActiveUsers::class);

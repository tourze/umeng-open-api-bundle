 ...
 * @internal
 */
#[CoversClass(WeeklyLaunches::class)]
final class WeeklyLaunchesTest extends AbstractEntityTestCase
{
    protected function createEntity(): object
    {
        return new WeeklyLaunches();
    }
    ...
    {
        $entity = $this->createWeeklyLaunches();
    ...
    private function createWeeklyLaunches(): WeeklyLaunches
    {
        $reflection = new \ReflectionClass(WeeklyLaunches::class);

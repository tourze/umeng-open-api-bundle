...
class GetWeeklyActiveUsersCommandTest extends TestCase
{
    public function testConfigure(): void
    {
        $entityManager = $this->createMock(EntityManagerInterface::class);
        $appRepository = $this->createMock(AppRepository::class);
        $activeUsersRepository = $this->createMock(WeeklyActiveUsersRepository::class);
        
        $command = new GetWeeklyActiveUsersCommand(
            $appRepository,

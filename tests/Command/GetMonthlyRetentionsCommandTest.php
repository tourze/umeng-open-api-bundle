...
class GetMonthlyRetentionsCommandTest extends TestCase
{
    public function testConfigure(): void
    {
        $entityManager = $this->createMock(EntityManagerInterface::class);
        $appRepository = $this->createMock(AppRepository::class);
        $retentionsRepository = $this->createMock(MonthlyRetentionsRepository::class);
        
        $command = new GetMonthlyRetentionsCommand(
            $appRepository,

...
class GetChannelDataCommandTest extends TestCase
{
    public function testConfigure(): void
    {
        ...
        $dailyChannelDataRepository = $this->createMock(DailyChannelDataRepository::class);
        
        $command = new GetChannelDataCommand(
            $appRepository,
            $channelRepository,
            $dailyChannelDataRepository,
            $entityManager
        );

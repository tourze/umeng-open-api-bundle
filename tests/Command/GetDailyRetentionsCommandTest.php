...
class GetDailyRetentionsCommandTest extends TestCase
{
    public function testConfigure(): void
    {
        $entityManager = $this->createMock(EntityManagerInterface::class);
        $appRepository = $this->createMock(AppRepository::class);
        $retentionsRepository = $this->createMock(DailyRetentionsRepository::class);
        
        $command = new GetDailyRetentionsCommand(
            $appRepository,

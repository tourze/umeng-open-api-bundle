...
class GetWeeklyLaunchesCommandTest extends TestCase
{
    public function testConfigure(): void
    {
        $entityManager = $this->createMock(EntityManagerInterface::class);
        $appRepository = $this->createMock(AppRepository::class);
        $launchesRepository = $this->createMock(WeeklyLaunchesRepository::class);
        
        $command = new GetWeeklyLaunchesCommand(
            $appRepository,
            $launchesRepository,
            $entityManager
        );

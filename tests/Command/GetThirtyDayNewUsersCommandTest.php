...
final class GetThirtyDayNewUsersCommandTest extends AbstractCommandTestCase
{
    ...
    private ThirtyDayNewUsersRepository&MockObject $thirtyDaysNewUsersRepository;
    ...
    protected function onSetUp(): void
    {
        ...
        $this->thirtyDaysNewUsersRepository = $this->createMock(ThirtyDayNewUsersRepository::class);
        ...
        self::getContainer()->set(ThirtyDayNewUsersRepository::class, $this->thirtyDaysNewUsersRepository);

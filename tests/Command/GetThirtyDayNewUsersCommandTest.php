...
class GetThirtyDayNewUsersCommandTest extends TestCase
{
    public function testConfigure(): void
    {
        $entityManager = $this->createMock(EntityManagerInterface::class);
        $appRepository = $this->createMock(AppRepository::class);
        $newUsersRepository = $this->createMock(ThirtyDayNewUsersRepository::class);
        
        $command = new GetThirtyDayNewUsersCommand(
            $appRepository,
            $newUsersRepository,
            $entityManager
        );

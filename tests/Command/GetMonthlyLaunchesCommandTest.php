...
class GetMonthlyLaunchesCommandTest extends TestCase
{
    public function testConfigure(): void
    {
        $entityManager = $this->createMock(EntityManagerInterface::class);
        $appRepository = $this->createMock(AppRepository::class);
        $launchesRepository = $this->createMock(MonthlyLaunchesRepository::class);
        
        $command = new GetMonthlyLaunchesCommand(
            $appRepository,
            $launchesRepository,
            $entityManager
        );

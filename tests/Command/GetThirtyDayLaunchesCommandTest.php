...
class GetThirtyDayLaunchesCommandTest extends TestCase
{
    public function testConfigure(): void
    {
        $entityManager = $this->createMock(EntityManagerInterface::class);
        $appRepository = $this->createMock(AppRepository::class);
        $launchesRepository = $this->createMock(ThirtyDayLaunchesRepository::class);
        
        $command = new GetThirtyDayLaunchesCommand(
            $appRepository,
            $launchesRepository,
            $entityManager
        );

...
class GetHourlyLaunchesCommandTest extends TestCase
{
    public function testConfigure(): void
    {
        $entityManager = $this->createMock(EntityManagerInterface::class);
        $appRepository = $this->createMock(AppRepository::class);
        $launchesRepository = $this->createMock(HourlyLaunchesRepository::class);
        $propertyAccessor = $this->createMock(PropertyAccessor::class);
        
        $command = new GetHourlyLaunchesCommand(
            $appRepository,
            $launchesRepository,
            $propertyAccessor,
            $entityManager

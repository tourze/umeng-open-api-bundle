...
class GetDailyActiveUsersCommandTest extends TestCase
{
    public function testConfigure(): void
    {
        $entityManager = $this->createMock(EntityManagerInterface::class);
        $appRepository = $this->createMock(AppRepository::class);
        $activeUsersRepository = $this->createMock(DailyActiveUsersRepository::class);
        
        $command = new GetDailyActiveUsersCommand(
            $appRepository,

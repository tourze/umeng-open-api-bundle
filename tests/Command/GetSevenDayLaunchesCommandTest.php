...
class GetSevenDayLaunchesCommandTest extends TestCase
{
    public function testConfigure(): void
    {
        $entityManager = $this->createMock(EntityManagerInterface::class);
        $appRepository = $this->createMock(AppRepository::class);
        $launchesRepository = $this->createMock(SevenDaysLaunchesRepository::class);
        
        $command = new GetSevenDayLaunchesCommand(
            $appRepository,
            $launchesRepository,
            $entityManager
        );

...
class DailyDurationRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var DailyDurationRepository $repository */
        $repository = $kernel->getContainer()->get(DailyDurationRepository::class);

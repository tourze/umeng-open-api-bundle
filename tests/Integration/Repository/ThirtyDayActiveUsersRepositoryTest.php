...
class ThirtyDayActiveUsersRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var ThirtyDayActiveUsersRepository $repository */
        $repository = $kernel->getContainer()->get(ThirtyDayActiveUsersRepository::class);

...
class MonthlyNewUsersRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var MonthlyNewUsersRepository $repository */
        $repository = $kernel->getContainer()->get(MonthlyNewUsersRepository::class);

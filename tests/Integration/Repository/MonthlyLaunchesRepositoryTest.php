...
class MonthlyLaunchesRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var MonthlyLaunchesRepository $repository */
        $repository = $kernel->getContainer()->get(MonthlyLaunchesRepository::class);

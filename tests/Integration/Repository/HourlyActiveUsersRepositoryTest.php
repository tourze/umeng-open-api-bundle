...
class HourlyActiveUsersRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var HourlyActiveUsersRepository $repository */
        $repository = $kernel->getContainer()->get(HourlyActiveUsersRepository::class);

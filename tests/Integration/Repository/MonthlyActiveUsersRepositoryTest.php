...
class MonthlyActiveUsersRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var MonthlyActiveUsersRepository $repository */
        $repository = $kernel->getContainer()->get(MonthlyActiveUsersRepository::class);

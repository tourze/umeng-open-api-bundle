...
class SevenDaysNewUsersRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var SevenDaysNewUsersRepository $repository */
        $repository = $kernel->getContainer()->get(SevenDaysNewUsersRepository::class);

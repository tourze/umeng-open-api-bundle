...
class WeeklyRetentionsRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var WeeklyRetentionsRepository $repository */
        $repository = $kernel->getContainer()->get(WeeklyRetentionsRepository::class);

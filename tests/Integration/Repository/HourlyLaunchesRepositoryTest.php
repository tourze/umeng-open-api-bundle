...
class HourlyLaunchesRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var HourlyLaunchesRepository $repository */
        $repository = $kernel->getContainer()->get(HourlyLaunchesRepository::class);

...
class ThirtyDayLaunchesRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var ThirtyDayLaunchesRepository $repository */
        $repository = $kernel->getContainer()->get(ThirtyDayLaunchesRepository::class);

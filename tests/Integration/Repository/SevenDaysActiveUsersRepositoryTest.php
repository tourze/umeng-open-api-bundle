...
class SevenDaysActiveUsersRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var SevenDaysActiveUsersRepository $repository */
        $repository = $kernel->getContainer()->get(SevenDaysActiveUsersRepository::class);

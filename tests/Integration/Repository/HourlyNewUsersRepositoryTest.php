...
class HourlyNewUsersRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var HourlyNewUsersRepository $repository */
        $repository = $kernel->getContainer()->get(HourlyNewUsersRepository::class);

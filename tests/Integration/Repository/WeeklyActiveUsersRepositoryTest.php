...
class WeeklyActiveUsersRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var WeeklyActiveUsersRepository $repository */
        $repository = $kernel->getContainer()->get(WeeklyActiveUsersRepository::class);

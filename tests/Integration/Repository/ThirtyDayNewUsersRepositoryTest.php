...
class ThirtyDayNewUsersRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var ThirtyDayNewUsersRepository $repository */
        $repository = $kernel->getContainer()->get(ThirtyDayNewUsersRepository::class);

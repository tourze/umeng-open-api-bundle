...
class DailyActiveUsersRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var DailyActiveUsersRepository $repository */
        $repository = $kernel->getContainer()->get(DailyActiveUsersRepository::class);

...
class DailyNewUsersRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var DailyNewUsersRepository $repository */
        $repository = $kernel->getContainer()->get(DailyNewUsersRepository::class);

...
class SevenDaysLaunchesRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var SevenDaysLaunchesRepository $repository */
        $repository = $kernel->getContainer()->get(SevenDaysLaunchesRepository::class);

...
class DailyRetentionsRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var DailyRetentionsRepository $repository */
        $repository = $kernel->getContainer()->get(DailyRetentionsRepository::class);

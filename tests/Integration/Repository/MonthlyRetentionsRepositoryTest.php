...
class MonthlyRetentionsRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var MonthlyRetentionsRepository $repository */
        $repository = $kernel->getContainer()->get(MonthlyRetentionsRepository::class);

...
class DailyLaunchesRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var DailyLaunchesRepository $repository */
        $repository = $kernel->getContainer()->get(DailyLaunchesRepository::class);

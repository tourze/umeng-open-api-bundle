...
class WeeklyLaunchesRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var WeeklyLaunchesRepository $repository */
        $repository = $kernel->getContainer()->get(WeeklyLaunchesRepository::class);

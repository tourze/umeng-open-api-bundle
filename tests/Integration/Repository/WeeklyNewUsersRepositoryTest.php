...
class WeeklyNewUsersRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->em = $em;
        /** @var WeeklyNewUsersRepository $repository */
        $repository = $kernel->getContainer()->get(WeeklyNewUsersRepository::class);

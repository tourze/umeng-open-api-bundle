 ...
 */
#[ORM\Entity(repositoryClass: MonthlyActiveUsersRepository::class)]
#[ORM\Table(name: 'ims_umeng_monthly_active_users', options: ['comment' => '活跃用户数by月'])]
#[ORM\UniqueConstraint(name: 'ims_umeng_monthly_active_users_idx_uniq', columns: ['app_id', 'date'])]
class MonthlyActiveUsers implements \Stringable
{

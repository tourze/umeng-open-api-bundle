 ...
 */
#[ORM\Entity(repositoryClass: SevenDaysLaunchesRepository::class)]
#[ORM\Table(name: 'ims_umeng_seven_day_launches', options: ['comment' => '启动次数by7天'])]
#[ORM\UniqueConstraint(name: 'ims_umeng_seven_day_launches_idx_uniq', columns: ['app_id', 'date'])]
class SevenDaysLaunches implements \Stringable
{

...
#[AsCommand(name: self::NAME, description: '获取App新增用户数(周)')]
final class GetWeeklyNewUsersCommand extends Command
{
    ...
    {
        $result = $this->dataFetcher->fetchWeeklyNewUsers($app, $startDate, $endDate);

...
final class GetThirtyDayLaunchesCommand extends Command
{
    ...
    {
        $result = $this->dataFetcher->fetchThirtyDayLaunches($app, $startDate, $endDate);
    ...
    private function saveResults(App $app, \UmengUappGetLaunchesResult $result): void
    {
        ...
        foreach ($launchInfo as $item) {
            ...
            $this->saveLaunchData($app, $date, $this->normalizeToInt($item->getValue()));
        }
    }
